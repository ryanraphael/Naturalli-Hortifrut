...
function atualizarCarrinho() {
    ...
    cart.forEach((item, index) => {
        ...
        // Preço total do item
        const precoTotalItem = document.createElement("span");
        precoTotalItem.textContent = ` - R$ ${(item.preco * item.quantidade).toFixed(2)}`;
        precoTotalItem.classList.add("cart-item-price");
